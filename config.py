...
DATA_SOURCES = [
    ...
    },
    {
        ...
        "api":     "https://api-open.data.gov.sg/v1/public/api/datasets/d_2c06c9fe8ae724b5d33efa1f203e2c38/poll-download",
        "updated": "Ongoing",
        "dl_key":  "mrt",
    },
    {
        ...
        "api":     "https://api-open.data.gov.sg/v1/public/api/datasets/d_688b934f82c1059ed0a6993d2a829089/poll-download",
        "updated": "Ongoing",
        "dl_key":  "schools",
    },
    {
        "layer":   "Hospitals",
        "source":  "OneMap — live keyword search (no static dataset)",
        "url":     "https://www.onemap.gov.sg/apidocs/",
        "api":     "https://www.onemap.gov.sg/api/common/elastic/search?searchVal=hospital&returnGeom=Y&getAddrDetails=Y",
        "updated": "Live",
        "dl_key":  None,
    },
    {
        "layer":   "Shopping Malls",
        "source":  "OneMap — live keyword search (no static dataset)",
        "url":     "https://www.onemap.gov.sg/apidocs/",
        "api":     "https://www.onemap.gov.sg/api/common/elastic/search?searchVal=mall&returnGeom=Y&getAddrDetails=Y",
        "updated": "Live",
        "dl_key":  None,
    },
    {
        ...
        "source":  "OneMap — live keyword search (no static dataset)",
        "url":     "https://www.onemap.gov.sg/apidocs/",
        "api":     "https://www.onemap.gov.sg/api/common/elastic/search?searchVal=fairprice+%7C+cold+storage+%7C+giant+%7C+sheng+siong&returnGeom=Y&getAddrDetails=Y",
        "updated": "Live",
        "dl_key":  None,
    },
    {
        ...
        "source":  "OneMap — live keyword search (no static dataset)",
        "url":     "https://www.onemap.gov.sg/apidocs/",
        "api":     "https://www.onemap.gov.sg/api/common/elastic/search?searchVal=park&returnGeom=Y&getAddrDetails=Y",
        "updated": "Live",
        "dl_key":  None,
    },
    {
        "layer":   "Community Centres",
        "source":  "OneMap — live keyword search (no static dataset)",
        "url":     "https://www.onemap.gov.sg/apidocs/",
        "api":     "https://www.onemap.gov.sg/api/common/elastic/search?searchVal=community+centre+%7C+community+club&returnGeom=Y&getAddrDetails=Y",
        "updated": "Live",
        "dl_key":  None,
    },
]
